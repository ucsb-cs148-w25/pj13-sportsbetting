...
- **Set Up Environment Variables**
  ...
  - Edit the `.env` file:
    - Set `ODDS_API_KEY` (get this key from the [Slack channel](https://ucsb-cs148-w25.slack.com/archives/C088RQFCDLY/p1737585688948609))
    - Set `BACKEND_SERVER_PORT` for the backend server
